...
var pmhostsCmd = &cobra.Command{
	Use:   "pmhosts",
	Short: "List of all hostnames in your account per property",
...
The related edgehost is shown and the host is checked to see if it is actually served by Akamai and resolves in a proper IP-address`,
